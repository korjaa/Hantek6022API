...
stock_firmware = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'stock_fw.ihex'))
mod_firmware_01 = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'mod_fw_01.ihex'))
mod_firmware_iso = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'mod_fw_iso.ihex'))
dso6021_firmware = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'dso6021-firmware.hex'))
dso6022be_firmware = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'dso6022be-firmware.hex'))
dso6022bl_firmware = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'dso6022bl-firmware.hex'))
dds120_firmware = fx2_ihex_to_control_packets(os.path.join(base_path, 'HEX', 'dds120-firmware.hex'))
